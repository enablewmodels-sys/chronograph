  ...
  return (
    <>
      ...
      <Tabs
        ...
        options={["Relationship", "Batch", "Node", "Invalidate"]}
        value={mode}
        onChange={setMode}
      />
      <div className="write-operation">
        {mode === "Relationship" && (
          <section className="panel form-panel" aria-label="Relationship">
              ...
              {typed ? (
                <div className="typed-properties">
                  ...
                  <p className="small muted">
                    The service validates and packs these values into the
                    16-byte payload.
                  </p>
                </div>
              ) : (
        ...
        {mode === "Batch" && (
          <section className="panel form-panel" aria-label="Batch">
            <h2>Atomic batch</h2>
            <p>
              Submit 1–10,000 versions together. IDs and timestamps must be
        ...
        {mode === "Node" && (
          <section className="panel form-panel" aria-label="Node">
        ...
        {mode === "Invalidate" && (
          <section className="panel form-panel" aria-label="Invalidate">
